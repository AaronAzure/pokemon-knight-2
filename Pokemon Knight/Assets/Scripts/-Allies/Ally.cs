...
public abstract class Ally : MonoBehaviour
{
	...
	public float headDist=0.01f;
	[Space] public bool registerMultipleLanding=false;
	protected bool once;
	...
	public virtual void CallChildOnHitHead() { isCeiling = true; }
	public virtual void CallChildOnLanded() { once = true; }
	public virtual void CallChildOnLateUpdate() {}
	public virtual void CallChildIsCeiling() 
	{ 
		RaycastHit2D ceilingInfo = Physics2D.Raycast(this.transform.position, Vector2.down, headDist, whatIsGround);
		if (!isCeiling && ceilingInfo && body != null && body.velocity.y == 0)
		{
			CallChildOnHitHead();
		}
	}
